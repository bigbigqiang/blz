...
(function($) {
    ...
    $.fn.pager = function(options) {
        ...
        return this.each(function() {
            renderpager(parseInt(options.pagenumber), parseInt(options.pagecount), options.buttonClickCallback)
    ...
    function renderpager(pagenumber, pagecount, buttonClickCallback) {
        var allPage = $('.allPage').find('span');
        allPage.html(pagecount);
        $('.pgBtn').on('click',function(){
            var _input = $('.currentPage input');
            ...
            switch (_index){
                case 0:value=1;
                    _input.val(value);
                    break;
                case 1:value>1&&value--;
                    _input.val(value);
                    break;
                case 4:value<pagecount&&value++;
                    _input.val(value);
                    break;
                case 5:value=pagecount;
                    _input.val(value);
                    break;
            }
