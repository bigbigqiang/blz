        ...
        function ajaxSceneData(scenePageData,num) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    //把场景来源添加到tab头上
                    var li='<li><a data-toggle="tab" href="#scene_tab'+num+'" aria-expanded="">'+obj.source+'<i class="scene'+num+' scene-icon-'+data.iconType+'"></i></a></li>';
                    ...
                    //先删除旧图层
                    var dbGeoJson=[mongoJson,mysqlJson,oracleJson,postgresqlJson,dmJson,kingdbJson,microsoftsqlserverJson,shentongJson,shangrongJson,dataJson];
                    ...
                    var geoPosMarker=L.icon({
                        iconUrl:'/image/geoPos_marker.png',
                        iconSize: [16, 16],
                        iconAnchor: [1, 11]
                    });
                    var planeMarker=L.icon({
                        iconUrl:'/image/plane_marker.png',
                        iconSize: [16, 16],
                        iconAnchor: [1, 11]
                    });
                    var trainMarker=L.icon({
                        iconUrl:'/image/train_marker.png',
                        iconSize: [16, 16],
                        iconAnchor: [1, 11]
                    });
                    var baseStationMarker=L.icon({
                        iconUrl:'/image/baseStation_marker.png',
                        iconSize: [16, 16],
                        iconAnchor: [1, 11]
                    });
                    var spaceDataMarker=L.icon({
                        iconUrl:'/image/spaceData_marker.png',
                        iconSize: [16, 16],
                        iconAnchor: [1, 11]
                    });
                    var marketMarker=L.icon({
                        iconUrl:'/image/market_marker.png',
                        iconSize: [16, 16],
                        iconAnchor: [1, 11]
                    });
                    var weatherMarker=L.icon({
                        iconUrl:'/image/weather_marker.png',
                        iconSize: [16, 16],
                        iconAnchor: [1, 11]
                    });
                    function difIconOnMap(geoJsonName,data,iconType){
                        switch (iconType){
                            case 'geoPos':
                                geoJsonName =L.geoJson(data,{
                                    //onEachFeature : onEachFeature,
                                    pointToLayer:function(feature,latlng){
                                        return  L.marker(latlng, {icon:geoPosMarker});
                                    }
                                }).addTo(map);
                            break;
                            case 'plane':
                                 geoJsonName =L.geoJson(data,{
                                    //onEachFeature : onEachFeature,
                                    pointToLayer:function(feature,latlng){
                                        return  L.marker(latlng, {icon:planeMarker});
                                    }
                                }).addTo(map);
                                break;
                            case 'train':
                                 geoJsonName =L.geoJson(data,{
                                    onEachFeature : onEachFeature,
                                    pointToLayer:function(feature,latlng){
                                        return   L.marker(latlng, {icon:trainMarker});
                                    }
                                }).addTo(map);
                                break;
                            case 'baseStation':
                                 geoJsonName =L.geoJson(data,{
                                    onEachFeature : onEachFeature,
                                    pointToLayer:function(feature,latlng){
                                        return   L.marker(latlng, {icon:baseStationMarker});
                                    }
                                }).addTo(map);
                                break;
                            case 'spaceData':
                                 geoJsonName =L.geoJson(data,{
                                    onEachFeature : onEachFeature,
                                    pointToLayer:function(feature,latlng){
                                        return   L.marker(latlng, {icon:spaceDataMarker});
                                    }
                                }).addTo(map);
                                break;
                            case 'market':
                            ...
                            case 'weather':
                                 geoJsonName =L.geoJson(data,{
                                    onEachFeature : onEachFeature,
                                    pointToLayer:function(feature,latlng){
                                        return    L.marker(latlng, {icon:weatherMarker});
                                    }
                                }).addTo(map);
                                break;
                            default :geoJsonName =L.geoJson(data,{
                                //onEachFeature : onEachFeature,
                                pointToLayer:function(feature,latlng){
                    ...
                    if(data.mysqlDataOnMap){
                        if(data.mysqlDataOnMap.features[0].geometry.type=="Point"){
                            difIconOnMap(mysqlJson,data.mysqlDataOnMap,data.iconType);
                        }
                        else{
                    ...
                    if(data.mongoDataOnMap){
                        if(data.mongoDataOnMap.features[0].geometry.type=="Point"){
                            difIconOnMap(mongoJson,data.mongoDataOnMap,data.iconType);
                        }
                        else{
                    ...
                    if(data.oracleDataOnMap){
                        if(data.oracleDataOnMap.features[0].geometry.type=="Point"){
                            difIconOnMap(postgresqlJson,data.oracleDataOnMap,data.iconType);
                        }
                        else{
                            postgresqlJson = L.geoJson(data.postgresqlDataOnMap, {
                                style : mapColorStyle,
                                onEachFeature : onEachFeature
                            }).addTo(map);
                        }
                        var dbNum=data.postgresqlDataOnMap.features.length;
                        eachDBData={"name":"postgresql","value":dbNum};
                        databaseData.push(eachDBData);
                    }
                    if(data.dmDataOnMap){
                        if(data.dmDataOnMap.features[0].geometry.type=="Point"){
                            difIconOnMap(dmJson,data.dmDataOnMap,data.iconType);
                        }
                        else{
                    ...
                    if(data.dataOnMap&&data.dataOnMap.features[0].geometry.type=="Point"){
                        difIconOnMap(dataJson,data.dataOnMap,data.iconType);
                    }else{
