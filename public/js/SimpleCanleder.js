(function ($) {
    $.simpleCanleder = function (box, options) {
        ...
        //var $select = canlederBox.find(_title_ul_li).eq(1).find("div.inner");
        ...
        function _init() {
            ...
            canlederBox.find(_title_ul_li).eq(1).find("div.inner").html(year);
        ...
        function _buildCanlederBox() {
            canlederBox = $("<div/>");
            canlederBox.attr("class", "SimpleCanleder_Year_Month");
        ...
        function _buildTitle(canlederBox) {
            ...
            $title_ul_li.eq(0).click(function () {
                var year = canlederBox.find(_title_ul_li).eq(1).find("div.inner").html();	//$select 在_getSelect()有定义
                canlederBox.find(_title_ul_li).eq(1).find("div.inner").html(--year);
            }).find("div.inner").text(" < ");
        ...
        function _buildBody(canlederBox) {
            ...
            for (var i = 0; i < 12; i++) {
                ...
                var $li = $("<li/>").append($inner).click(function () {
                    var year = canlederBox.find(_title_ul_li).eq(1).find("div.inner").html();
