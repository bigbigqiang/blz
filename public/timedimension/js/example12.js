...
L.TimeDimension.Layer.SODAHeatMap = L.TimeDimension.Layer.extend({
    ...
    _constructQuery: function(time) {
        ...
        //修改请求的地址，换成本地的
        var url = '/timedimension/json/'+startDate.format('yyyy-mm-dd')+'.json';
        return url;
    }
...
var map = L.map('map', {
    ...
    timeDimensionOptions: {
        timeInterval: "2010-01-01/" + "2010-12-04",
        period: "P1M",
...
L.tileLayer('http://192.168.0.199:9999/mapbox-studio-dark/{z}/{x}/{y}' + (L.Browser.retina ? '@2x' : '') + '.png').addTo(map);
